...
setwd("/home/jw18713/machine_learning_project/datasets/S2_histone")
...
STARRrep1 <- read.delim("/home/jw18713/machine_learning_project/datasets/S2_starr_seq/S2_STARRseq_rep1.peaks.txt", header = F, sep = "\t")
STARRgro <- GRanges(seqnames = STARRrep1[,1], ranges = IRanges(STARRrep1[,2]-200, STARRrep1[,2]+200)) #Creating a GRange object for STARR seq data (summit +- 100 bases)
...
save(output_max, file="/home/jw18713/Project1/R_objects/S2_denorm_max_400bp.Rda")
save(output_min, file="/home/jw18713/Project1/R_objects/S2_denorm_min_400bp.Rda")
...
save(dm6_tiles, file="/home/jw18713/Project1/R_objects/S2_tiles_400bp.Rda")

dfwrite <- as.data.frame(dm6_tiles)
write.csv(dfwrite, file="/home/jw18713/Project1/data/norm_S2_400bp.csv", row.names=F)
