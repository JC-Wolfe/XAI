...
all_data <- get(load("/home/jw18713/Project1/R_objects/S2_tiles_400bp.Rda")) #Loading in full S2 dataset as all_data
...
save(chr_split_resampled, file = "/home/jw18713/Project1/R_objects/1million_norm_S2_400bp.Rda")
write.csv(as.data.frame(chr_split_resampled), file = "/home/jw18713/Project1/data/1million_norm_S2_400bp.csv", row.names = F)
