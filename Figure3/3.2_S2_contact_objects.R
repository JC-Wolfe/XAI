...
gr_contacts <- get(load("~/dm6_promoter_correction/Contact_Maps/useful_HiC_dm6_contactMap_S2.Rda"))
...
save(p5k, file = "~/dm6_promoter_correction/Objects/S2_over5k_contacts.Rda")
save(p_under5k, file = "~/dm6_promoter_correction/Objects/S2_under5k_contacts.Rda")
