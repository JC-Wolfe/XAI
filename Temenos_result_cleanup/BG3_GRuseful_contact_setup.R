...
save(gr_contacts, file = "useful_HiC_dm6_contactMap_BG3.Rda")

load("/home/jw18713/Project1/data/model_predictions/BG3_FuzzyGR.Rda") #grown_predicted_enhancers_BG3
starr <- reduce(gro[gro$STARR_seq_binary == 1])
save(starr, file = "starr_BG3.Rda")
