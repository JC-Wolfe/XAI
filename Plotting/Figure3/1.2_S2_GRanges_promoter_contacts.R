...
load("/home/jw18713/dm6_promoter_correction/dm6_annotations/dm6_annotation.Rda") # dm6_annotation
...
save(gr_contacts, file = "~/dm6_promoter_correction/Contact_Maps/useful_HiC_dm6_contactMap_S2.Rda")
