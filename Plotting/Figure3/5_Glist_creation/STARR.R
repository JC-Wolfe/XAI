...
save(BG3_starr_dist, file = "~/dm6_promoter_correction/Full_glists/starr/BG3_starr_dist.Rda")
# Proximal
BG3_starr_prox <- proximal_expression(sort(c(BG3_starr_res[[1]],BG3_starr_res[[3]])),
  g_exp = expression_data, line = "BG3")
save(BG3_starr_prox, file = "~/dm6_promoter_correction/Full_glists/starr/BG3_starr_prox.Rda")
...
save(S2_starr_dist, file = "~/dm6_promoter_correction/Full_glists/starr/S2_starr_dist.Rda")
# Proximal
S2_starr_prox <- proximal_expression(sort(c(S2_starr_res[[1]],S2_starr_res[[3]])),
  g_exp = expression_data, line = "S2")
save(S2_starr_prox, file = "~/dm6_promoter_correction/Full_glists/starr/S2_starr_prox.Rda")
