...
save(BG3_common_dist, file = "~/dm6_promoter_correction/Full_glists/common/BG3_common_dist.Rda")
# Proximal
BG3_common_prox <- proximal_expression(sort(c(BG3_shared[[1]],BG3_shared[[3]])),
  g_exp = expression_data, line = "BG3")
save(BG3_common_prox, file = "~/dm6_promoter_correction/Full_glists/common/BG3_common_prox.Rda")
...
save(S2_common_dist, file = "~/dm6_promoter_correction/Full_glists/common/S2_common_dist.Rda")
# Proximal
S2_common_prox <- proximal_expression(sort(c(S2_shared[[1]],S2_shared[[3]])),
  g_exp = expression_data, line = "S2")
save(S2_common_prox, file = "~/dm6_promoter_correction/Full_glists/common/S2_common_prox.Rda")
