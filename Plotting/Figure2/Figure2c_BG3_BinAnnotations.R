...
pdf("/home/jw18713/Project1/Paper_Plots/Figure2/Figure2C.pdf")
par(mar=c(4,4,4,10.5))
par(xpd = NA)
barplot(results_matrix_aves, col=cs, xlab="Result Classification", ylab="Percentage of Results in Region", main="BG3 Annotation Comparisons", yaxt = "none")
...
pdf(file = "/home/jw18713/Project1/Paper_Plots/Figure2/Figure2C_Var.pdf")
